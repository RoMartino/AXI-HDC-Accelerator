...
user.org:user:HDC_HW_Accelerator_v1_0_wrapper:1.0\
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set rst_status_0 [ create_bd_port -dir O -from 0 -to 0 rst_status_0 ]

  # Create instance: AXI_STREAM_PL_TO_PS, and set properties
  set AXI_STREAM_PL_TO_PS [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_data_fifo:2.0 AXI_STREAM_PL_TO_PS ]
  ...
  # Create instance: AXI_STREAM_PS_TO_PL, and set properties
  set AXI_STREAM_PS_TO_PL [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_data_fifo:2.0 AXI_STREAM_PS_TO_PL ]
  set_property -dict [ list \
   CONFIG.FIFO_DEPTH {512} \
   CONFIG.FIFO_MEMORY_TYPE {auto} \
   CONFIG.HAS_AEMPTY {0} \
  ...
  # Create instance: HDC_HW_Accelerator_v_0, and set properties
  set HDC_HW_Accelerator_v_0 [ create_bd_cell -type ip -vlnv user.org:user:HDC_HW_Accelerator_v1_0_wrapper:1.0 HDC_HW_Accelerator_v_0 ]
  set_property -dict [ list \
   CONFIG.ADDR_WIDTH {16} \
   CONFIG.COUNTER_BITS {16} \
   CONFIG.PERFORMANCE_COUNTER {false} \
   CONFIG.SIMD {16} \
 ] $HDC_HW_Accelerator_v_0
...
gpio[0]#qspi0_ss_b#qspi0_io[0]#qspi0_io[1]#qspi0_io[2]#qspi0_io[3]/HOLD_B#qspi0_sclk#gpio[7]#qspi_fbclk#gpio[9]#gpio[10]#gpio[11]#gpio[12]#gpio[13]#gpio[14]#gpio[15]#tx_clk#txd[0]#txd[1]#txd[2]#txd[3]#tx_ctl#rx_clk#rxd[0]#rxd[1]#rxd[2]#rxd[3]#rx_ctl#data[4]#dir#stp#nxt#data[0]#data[1]#data[2]#data[3]#clk#data[5]#data[6]#data[7]#clk#cmd#data[0]#data[1]#data[2]#data[3]#reset#cd#tx#rx#gpio[50]#gpio[51]#mdc#mdio} \
  ...
  connect_bd_intf_net -intf_net AXI_STREAM_PL_TO_PS_M_AXIS [get_bd_intf_pins AXI_STREAM_PL_TO_PS/M_AXIS] [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM]
  connect_bd_intf_net -intf_net AXI_STREAM_PS_TO_PL_M_AXIS [get_bd_intf_pins AXI_STREAM_PS_TO_PL/M_AXIS] [get_bd_intf_pins HDC_HW_Accelerator_v_0/s_axis]
  connect_bd_intf_net -intf_net HDC_HW_Accelerator_v_0_m_axis [get_bd_intf_pins AXI_STREAM_PL_TO_PS/S_AXIS] [get_bd_intf_pins HDC_HW_Accelerator_v_0/m_axis]
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins AXI_STREAM_PS_TO_PL/S_AXIS] [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins HDC_HW_Accelerator_v_0/s00_axi] [get_bd_intf_pins ps7_0_axi_periph/M01_AXI]
  ...
  connect_bd_net -net HDC_HW_Accelerator_v_0_busy_hdc_o [get_bd_pins HDC_HW_Accelerator_v_0/busy_hdc_o] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net HDC_HW_Accelerator_v_0_load_store_busy_o [get_bd_pins HDC_HW_Accelerator_v_0/load_store_busy_o] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins AXI_STREAM_PL_TO_PS/s_axis_aclk] [get_bd_pins AXI_STREAM_PS_TO_PL/s_axis_aclk] [get_bd_pins HDC_HW_Accelerator_v_0/clk_i] [get_bd_pins HDC_HW_Accelerator_v_0/s00_axi_aclk] [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk] [get_bd_pins smartconnect_0/aclk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_50M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins AXI_STREAM_PL_TO_PS/s_axis_aresetn] [get_bd_pins AXI_STREAM_PS_TO_PL/s_axis_aresetn] [get_bd_pins HDC_HW_Accelerator_v_0/s00_axi_aresetn] [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn] [get_bd_pins smartconnect_0/aresetn]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins processing_system7_0/IRQ_F2P] [get_bd_pins xlconcat_0/dout]
  connect_bd_net -net xlslice_0_Dout [get_bd_ports rst_status_0] [get_bd_pins HDC_HW_Accelerator_v_0/rst_ni] [get_bd_pins axi_gpio_0/gpio_io_o]

  # Create address segments
  assign_bd_address -offset 0x30000000 -range 0x04000000 -target_address_space [get_bd_addr_spaces axi_dma_0/Data_MM2S] [get_bd_addr_segs processing_system7_0/S_AXI_HP0/HP0_DDR_LOWOCM] -force
  assign_bd_address -offset 0x34000000 -range 0x04000000 -target_address_space [get_bd_addr_spaces axi_dma_0/Data_S2MM] [get_bd_addr_segs processing_system7_0/S_AXI_HP0/HP0_DDR_LOWOCM] -force
  assign_bd_address -offset 0x40000000 -range 0x00001000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs HDC_HW_Accelerator_v_0/s00_axi/reg0] -force
